...
<!--        <q-btn icon-right="close" v-close-popup dense flat color="primary"/>-->
      ...
      <q-card-section>
        ...
        <div class="text-center text-subtitle1 q-mt-md">
          ...
          <div v-if="wallet.btmtBalance" class="text-center text-primary">Balance: <span class="text-white text-bold">{{ getFormattedNumber(wallet.btmtBalance) }} </span> OWLC <small v-if="wallet.btmtBalance" class="text-white q-pl-md">~750$</small></div>
